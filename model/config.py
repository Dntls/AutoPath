...
def parse_args():
	...
	parser.add_argument('--learning_rate', type=float, default=1e-2, help=None)
	...
	parser.add_argument('--batch_size', type=int, default=400, help='Number of trajectories sampled')
	parser.add_argument('--trajectory_length', type=int, default=2, help=None)
	parser.add_argument('--epoch', type=int, default=200, help=None)
	parser.add_argument('--classification_step', type=int, default=5, help='Number of rounds of mini batch SGD per epoch for classification')
...
def init_dir(args):
	...
	args.plot_file = '../log/reward.png'
	args.model_file = args.model_dir + 'model.ckpt'
	args.rank_list_file = '../tmp/rank_list.pkl'
